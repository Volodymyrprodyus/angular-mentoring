...
export class ContextStoreFacadeService {
  ...
  public dispatchFetchAuthorsList(): void {
    this.store.dispatch(authorsActions.fetchAuthorsFromApi());
  }
  ...
  public selectAuthorsList(): Observable<ListOption[]> {
    return this.store.select(authorsSelectors.selectAuthorsList);
  }
